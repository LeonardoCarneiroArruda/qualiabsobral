...
$respostas = $respostas->retornaDadosGraficoQuestao39();
...
// Valores por década
$data = array(
             array('Sim' , $respostas["sim"]), 
             array('Nao' , $respostas["nao"]),
             array('Nao sabe informar', $respostas["naoPossuiDados"]),
             array('Nao se aplica', $respostas["naoAplica"])
             );     

  ...
  <?php }else{ ?>
    ...
    <!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Essa questão não trabalha com pontuação</p>
        <div class="row">
          <div class="col-xs-4">
            <a href="/qualiabsobral/perguntas"><button class="btn btn-primary btn-md"> VOLTAR </button></a>
          </div>
        </div>
      </div>
    <!-- /.login-box-body -->
